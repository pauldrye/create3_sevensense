...
#define NODE_MAIN_LOGGER_NAME "kidnap_estimator_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libkidnap_estimator_publisher_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<irobot_create_nodes::KidnapEstimator>";
