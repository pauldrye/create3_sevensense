...
#define NODE_MAIN_LOGGER_NAME "ui_mgr"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libui_mgr_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<irobot_create_nodes::UIMgr>";
