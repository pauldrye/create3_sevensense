...
#define NODE_MAIN_LOGGER_NAME "wheel_status_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libwheel_status_publisher_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<irobot_create_nodes::WheelsPublisher>";
