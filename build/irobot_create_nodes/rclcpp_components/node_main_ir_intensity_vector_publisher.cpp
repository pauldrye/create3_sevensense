...
#define NODE_MAIN_LOGGER_NAME "ir_intensity_vector_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libir_intensity_publisher_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<irobot_create_nodes::IrIntensityVectorPublisher>";
