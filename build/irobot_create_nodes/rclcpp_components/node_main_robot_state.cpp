...
#define NODE_MAIN_LOGGER_NAME "robot_state"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librobot_state_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<irobot_create_nodes::RobotState>";
