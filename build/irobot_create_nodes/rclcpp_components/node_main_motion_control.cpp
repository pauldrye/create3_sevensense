...
#define NODE_MAIN_LOGGER_NAME "motion_control"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmotion_control_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<irobot_create_nodes::MotionControlNode>";
