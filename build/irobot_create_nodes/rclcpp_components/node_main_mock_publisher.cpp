...
#define NODE_MAIN_LOGGER_NAME "mock_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmock_publisher_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<irobot_create_nodes::MockPublisher>";
